...
//			/*arguments[0] refers to the first argument passed to the JavaScript code. In this case, it represents vimage.
//			.style.border='2px green solid'; sets the border of the element to a solid green line with a width of 2 pixels.*/
		}
	}
}
