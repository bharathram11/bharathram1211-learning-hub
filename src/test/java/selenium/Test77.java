...
public class Test77
{
	public static void main(String[] args) throws Exception
	{
		...
		driver.switchTo().window(l.get(2)); //switch to newly opened 3rd window/tab
		...
		//driver.quit(); //All browser windows/tabs will be closed
		//OR
		driver.close();
		//back to 2nd window/tab from 3rd window/tab
