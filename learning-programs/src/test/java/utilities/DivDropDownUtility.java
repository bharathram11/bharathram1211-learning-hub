...
public final class DivDropDownUtility 
{
	private DivDropDownUtility()
	{
	}
	
	public static boolean isMultiSelect(WebElement dd)
	{
	...
	public static int getItemsCount(WebElement dd)
	{
		int value=dd.findElements(By.xpath("descendant::div[@class='item']")).size();
		return(value);
	}
	
	public static List<String> getItemsNames(WebDriver driver, WebElement dd)
	{
	...
	public static void selectItemByIndex(WebElement dd, int x) throws Exception
	{
	...
	public static void selectItemByName(WebDriver driver, WebElement dd, String x) throws Exception
	{
		dd.click(); //open drop down
		Thread.sleep(5000);
		List<WebElement> items=dd.findElements(By.xpath("descendant::div[@class='item']"));
	...
	public static void selectItemsByIndexes(WebElement dd, int[] x) throws Exception
	{
		dd.click(); //open drop down
		Thread.sleep(5000);
	...
	public static void selectItemsByNames(WebDriver driver, WebElement dd, String[] x) throws Exception
	{
		dd.click(); //open drop down
		Thread.sleep(5000);
		List<WebElement> items=dd.findElements(By.xpath("descendant::div[@class='item']"));
	...
	public static void selectAllItems(WebElement dd) throws Exception
	{
		dd.click(); //open drop down
		Thread.sleep(5000);
		//collect all items
	...
	public static void deselectItemsByIndexes(WebElement dd, int[] x) throws Exception
	{
	...
	public static void deselectItemsByNames(WebDriver driver, WebElement dd, String[] x) throws Exception
	{
		//collect all selected items only
		List<WebElement> items=dd.findElements(By.xpath("child::a"));
		for(int i=0; i<x.length; i++)
	...
	public static void deselectAllItems(WebElement dd) throws Exception
	{
		//collect all selected items only
		List<WebElement> items=dd.findElements(By.xpath("child::a"));
		for(WebElement item:items)
	...
	public static String getSelectedItemInSingleSelect(WebElement dd)
	{
		WebElement sitem=dd.findElement(By.xpath("child::div[@class='text']"));
		return(sitem.getText());
	}
	
	public static String getFirstSelectedItem(WebElement dd)
	{
		List<WebElement> sitems=dd.findElements(By.xpath("child::a"));
		return(sitems.get(0).getText());
	}
	
	public static String getLastSelectedItem(WebElement dd)
	{
		List<WebElement> sitems=dd.findElements(By.xpath("child::a"));
		return(sitems.get(sitems.size()-1).getText());
	}
	
	public static List<String> getAllSelectedItems(WebElement dd)
	{
	...
	public static boolean compareTwoLists(List<String> ex, List<String> ax)
	{
